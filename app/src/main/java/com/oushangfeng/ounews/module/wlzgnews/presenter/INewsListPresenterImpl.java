package com.oushangfeng.ounews.module.wlzgnews.presenter;
...
import com.oushangfeng.ounews.module.wlzgnews.model.INewsListInteractor;
import com.oushangfeng.ounews.module.wlzgnews.model.INewsListInteractorImpl;
...
public class INewsListPresenterImpl
        extends BasePresenterImpl<INewsListView, RemoteResult>
        implements INewsListPresenter {

    private INewsListInteractor<RemoteResult> mNewsListInteractor;
    ...
    public INewsListPresenterImpl(INewsListView newsListView, String newsId, String newsType) {
        ...
        mSubscription = mNewsListInteractor.requestNewsList(this, newsId);
        mNewsType = newsType;
        mNewsId = newsId;
    }
    ...
    @Override
    public void requestSuccess(RemoteResult data) {
        KLog.e("请求成功");
        mHasInit = true;
        if (data != null) {
            mStartPage += 20;
    ...
    public void refreshData() {
        mStartPage = 0;
        mIsRefresh = true;
        mSubscription = mNewsListInteractor.requestNewsList(this, mNewsId);
    }
