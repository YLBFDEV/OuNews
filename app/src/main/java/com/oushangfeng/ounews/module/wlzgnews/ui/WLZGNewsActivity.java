...
import com.oushangfeng.ounews.module.wlzgnews.presenter.INewsPresenter;
import com.oushangfeng.ounews.module.wlzgnews.presenter.INewsPresenterImpl;
import com.oushangfeng.ounews.module.wlzgnews.view.INewsView;
...
@ActivityFragmentInject(contentViewId = R.layout.activity_news,
        ...
        toolbarTitle = R.string.wlzgnews,
        toolbarIndicator = R.drawable.ic_list_white,
        menuDefaultCheckedItem = R.id.action_wlzgnews)
public class WLZGNewsActivity extends BaseActivity<INewsPresenter> implements INewsView {
    ...
    public void initViewPager(List<NewsChannelTable> newsChannels) {
        ...
        final List<String> title = Arrays.asList("资讯", "技术", "应用", "服务");
